(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ag-grid-community-charts')) :
    typeof define === 'function' && define.amd ? define('ag-grid-angular-charts', ['exports', '@angular/core', 'ag-grid-community-charts'], factory) :
    (global = global || self, factory(global['ag-grid-angular-charts'] = {}, global.ng.core, global.agGridCommunityCharts));
}(this, (function (exports, core, agGridCommunityCharts) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AgGridChartsColumn = /** @class */ (function () {
        ...
        __decorate([
            core.ContentChildren(AgGridChartsColumn_1),
    ...
    }(agGridCommunityCharts.VanillaFrameworkOverrides));
    ...
    }(agGridCommunityCharts.BaseComponentWrapper));
    ...
    var AgGridChartsAngular = /** @class */ (function () {
        function AgGridChartsAngular(elementDef, viewContainerRef, angularFrameworkOverrides, frameworkComponentWrapper, _componentFactoryResolver) {
            ...
            this._fullyReady = agGridCommunityCharts.Promise.resolve(true);
            // @START@
        ...
        AgGridChartsAngular.prototype.ngAfterViewInit = function () {
            this.gridOptions = agGridCommunityCharts.ComponentUtil.copyAttributesToGridOptions(this.gridOptions, this, true);
            this.gridParams = {
            ...
            new agGridCommunityCharts.Grid(this._nativeElement, this.gridOptions, this.gridParams);
        ...
        AgGridChartsAngular.prototype.ngOnChanges = function (changes) {
            if (this._initialised) {
                agGridCommunityCharts.ComponentUtil.processOnChange(changes, this.gridOptions, this.api, this.columnApi);
            }
        };
        ...
        __decorate([
            core.ContentChildren(AgGridChartsColumn),
            __metadata("design:type", core.QueryList)
    ...
    exports.AgGridChartsAngular = AgGridChartsAngular;
    exports.AgGridChartsColumn = AgGridChartsColumn;
    exports.AgGridChartsModule = AgGridChartsModule;
...
//# sourceMappingURL=ag-grid-angular-charts.umd.js.map
